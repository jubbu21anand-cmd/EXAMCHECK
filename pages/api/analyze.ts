...
3. Identify: missing marks, excess deductions, valid alternative approaches, and correctly marked questions
4. Check if examiner annotations match what the marking scheme requires
5. If student used a different but logically valid method, flag as alternative valid approach
